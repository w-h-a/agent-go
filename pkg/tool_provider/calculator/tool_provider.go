...
func (tp *calculatorToolProvider) Name() string { return "calculator" }

func (tp *calculatorToolProvider) Description() string {
	return "Evaluates simple math expressions such as '2 + 2' or '5 * 3'."
}

func (tp *calculatorToolProvider) Run(_ context.Context, input string) (string, error) {
